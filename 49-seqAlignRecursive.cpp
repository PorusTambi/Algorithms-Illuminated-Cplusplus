...
int dpDist(int i, int j, string &w1, string &w2,
...
int minDistance(string word1, string word2)
{
    ...
    int ans = dpDist(0, 0, word1, word2, memo);
           ...
           vector<vector<int>> &memo)
{
    ...
    int a = 1 + dpDist(i + 1, j, w1, w2, memo);                            //delete
    int b = 1 + dpDist(i, j + 1, w1, w2, memo);                            //insert
    int c = (w1[i] == w2[j] ? 0 : 1) + dpDist(i + 1, j + 1, w1, w2, memo); //matching
